            ...
            <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-xl font-extrabold tracking-wide">
                        PokéDex <span className="text-indigo-300 font-normal text-sm">202601</span>
                    </h1>
                </div>
                ...
                <nav className="hidden md:block">
                    <ul className="flex items-center gap-1">
                        {NAV_LINKS.map(({ label, path }) => (
                            <li key={label}>
                                <button
                                    className="px-4 py-2 rounded-md text-sm font-medium hover:bg-indigo-600 transition-colors"
                ...
                <nav className="bg-indigo-800 px-4 pb-3">
                    <ul className="flex flex-col gap-1 pt-2">
                        {NAV_LINKS.map(({ label, path }) => (
                            <li key={label}>
                                <button
                                    className="w-full text-left px-4 py-2 rounded-md text-sm font-medium hover:bg-indigo-600 transition-colors"
                                    onClick={() => handleNavigation(path)}
                                >
                                    {label}
                                </button>
